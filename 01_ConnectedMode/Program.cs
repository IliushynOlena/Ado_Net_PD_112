...
namespace _01_ConnectedMode
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //string connection = @"Data Source=UniversityDB2023.mssql.somee.com;
            //                    Initial Catalog=UniversityDB2023;Integrated Security=False;
            ...
            {
                Console.Write("{0,17}", reader.GetName(i));
